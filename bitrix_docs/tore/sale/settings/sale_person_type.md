...
| Действия | Действия над типом плательщика:  * **Изменить** - [редактирование](/user_help/store/sale/settings/sale_person_type_edit.php) выбранного типа плательщика; * **Удалить** - удаление выбранного типа плательщика. |
| ID | Идентификатор типа плательщика. |
| Название | Название типа плательщика, как оно будет показано клиентам магазина при оформлении заказа. |
| Код | Код типа, задаваемый пользователем. Может использоваться при работе с API. |
| Активность | Активность данного типа плательщика. |
...
| Сорт. | Относительный "вес" данного типа плательщика. Используется для определения порядка показа типов плательщика в списке. |
| Свойства | Ссылка для перехода к просмотру свойств заказа, заданных для данного типа плательщика. |
