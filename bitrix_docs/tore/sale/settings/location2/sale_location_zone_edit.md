# Выбор местоположений для сайта
...
Данная форма служит для привязки местоположений к сайту.
...
| Доступные местоположения | В данной секции представлены все доступные в системе местоположения и созданные группы местоположений. Поиск необходимых местоположений для текущего сайта можно осуществлять с помощью строки поиска или с помощью дерева местоположений. Те местоположения и/или группы местоположений, которые необходимо перенести в список выбранных, следует отметить флагом и нажать кнопку **>**. |
...
| Применить | Применение внесённых изменений. Продолжение редактирования параметров привязки местоположений к сайту. |
