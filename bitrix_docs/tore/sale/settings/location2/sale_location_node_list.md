...
| Действия | Действия над местоположением:  * **Редактировать местоположение** - переход к форме [редактирования](/user_help/store/sale/settings/location2/sale_location_node_edit.php) местоположения. * **Копировать местоположение** - переход к форме добавления местоположения, в которую будут скопированы параметры текущего местоположения.* **Удалить местоположение**- удаление местоположения. |
| ID | Идентификатор местоположения. |
| Сортировка | Относительный "вес" местоположения. Влияет на размещение местоположения в общем списке. |
| Тип | Тип местоположения. |
| Широта | Широта местоположения. |
| Долгота | Долгота местоположения. |
| Название (<*язык\_интерфейса*>) | Название местоположения, указанное для данного языка интерфейса. |
| Краткое название (<*язык\_интерфейса*>) | Краткое название местоположения, указанное для данного языка интерфейса. |
