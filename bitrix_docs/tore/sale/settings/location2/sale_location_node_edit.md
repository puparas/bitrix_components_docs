...
| Родительское местоположение | Указывается родительское местоположение по отношению к данному. |
...
| \*Название | Указывается полное наименование местоположения для каждого языка, используемого в системе. |
...
|  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Таблица внешних данных   |  |  | | --- | --- | | ID | Идентификатор внешнего кода местоположения. | | Код сервиса | Код внешнего сервиса, с которым система обменивается данными по местоположениям (например, код службы доставки). | | Внешний код | Код местоположения в системе текущего внешнего сервиса. | | Удал. | Служит для удаления заданного внешнего кода. | | |
| Кнопка "Еще" | Кнопка служит для добавления новых строк в таблицу внешних данных. |
