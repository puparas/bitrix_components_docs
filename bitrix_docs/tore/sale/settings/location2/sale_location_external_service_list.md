...
| Действия | Действия над местоположением:  * **Редактировать сервис** - переход к форме [редактирования](/user_help/store/sale/settings/location2/sale_location_external_service_edit.php) внешнего сервиса. * **Копировать сервис** - переход к форме добавления внешнего сервиса, в которую будут скопированы параметры текущего сервиса.* **Удалить сервис**- удаление сервиса. |
| ID | Идентификатор внешнего сервиса. |
| Код сервиса | Код внешнего сервиса. |
