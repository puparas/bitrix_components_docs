...
Страница **Местоположения для сайтов** (*Магазин > Настройки > Местоположения > Местоположения для сайтов*) служит для настройки привязки местоположений к сайтам системы.
