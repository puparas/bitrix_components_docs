# Настройка избранных местоположений
...
Данная форма служит для выбора избранных местоположений для сайта.
...
| Сортировка | Относительный "вес", влияющий на положение данного местоположения в общем списке избранных местоположений. |
...
| Применить | Применение внесённых изменений. Продолжение выбора избранных местоположений. |
