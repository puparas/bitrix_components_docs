...
| Действия | Действия над местоположением:  * **Редактировать тип** - переход к форме [редактирования](/user_help/store/sale/settings/location2/sale_location_type_edit.php) типа местоположений. * **Копировать тип** - переход к форме добавления типа местоположения, в которую будут скопированы параметры текущего типа.* **Удалить тип**- удаление типа местоположений. |
| ID | Идентификатор типа местоположений. |
| Сортировка | Относительный "вес" типа местоположений. Влияет на размещение типов в общем списке. |
| Название (<*язык\_интерфейса*>) | Название типа местоположений, указанное на данном языке интерфейса. |
