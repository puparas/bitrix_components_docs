# Создание и редактирование типа местоположения
...
Данная форма служит для создания нового и редактирования параметров уже существующего типа местоположений.
...
| \*Символьный код | Символьный код типа местоположений. |
...
| Приоритет вывода | Относительный "вес", влияющий на положение данного типа местоположений в общем списке. |
| Языковые названия (<*язык\_интерфейса*>) | |
| \*Название | Указывается наименование типа местоположений для каждого языка, используемого в системе. |
...
| Применить | Применение внесённых изменений. Продолжение редактирования типа местоположений. |
| Отменить | Отмена внесённых изменений. Возврат первоначальных значений параметров. |
| Сохранить и добавить | Сохранение внесённых изменений. Переход на страницу создания нового типа местоположений. |
