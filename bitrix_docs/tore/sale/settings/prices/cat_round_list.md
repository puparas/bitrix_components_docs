...
Правила округления цен (с версии 16.5.4)
...
- [Список правил округления](#list)
--!>

Страница **Правила округления цен** (*Магазин > Настройки > Цены > Округление*) служит для управления правилами округления цен.

  

### Форма поиска

С помощью данной формы вы можете выполнить поиск правил округления в соответствии с указанными условиями.
...
| Действия | Действия над правилом:  * **Редактировать** - [редактирование](/user_help/store/sale/settings/prices/cat_round_edit.php) правила; * **Копировать** - добавление нового правила путем копирования параметров текущего; * **Удалить** - удаление правила. |
| ID | Идентификатор правила в базе данных. |
| Тип цен | Тип цены, для которого создано правило. |
...
| Кем создано | Имя пользователя, создавшего правило. |
| Дата создания | Дата и время создания правила. |
| Кем изменено | Имя пользователя, который последним изменил правило. |
| Дата изменения | Дата и время последнего изменения правила. |
