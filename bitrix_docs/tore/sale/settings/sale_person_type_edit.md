# Создание и редактирование типа плательщика
...
| Активность | Признак активности. Активный тип доступен для работы в рамках интернет-магазина. |
...
| \*Название | Название типа плательщика. |
| Код | Код типа, задаваемый пользователем. Может использоваться при работе с API. |
| Индекс сортировки | Относительный "вес", влияющий на положение типа плательщика в общем списке и в публичной части качестве типа по умолчанию. Штатно по умолчанию первым отображается тип Физическое лицо. Если нужно по умолчанию выводить другой тип, поставьте "Физическому лицу" более низкое значение в этом поле. |
| Внешний код | Код, задаваемый системой. Может использоваться при работе с API. |
| Соответствие с физ. и юр. лицом | Выбор из выпадающего списка нужного типа плательщика: физическое лицо, юридическое лицо либо не установлено. Эта опция нужна для работы механизма [бизнес-смыслов](/user_help/store/sale/settings/sale_business_value.php). |

\* - поля, обязательные для заполнения.

### Смотрите также

* [Типы плательщиков (учебный курс "Администратор. Бизнес")](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=42&LESSON_ID=2186)
