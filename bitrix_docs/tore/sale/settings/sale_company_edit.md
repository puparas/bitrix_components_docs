...
На данной закладке отображаются созданные в системе дополнительные пользовательские поля для компаний. К созданию нового пользовательского поля можно перейти по ссылке [Добавить пользовательское поле](/user_help/settings/settings/userfield_admin.php).

### Правила

На закладке задаются правила для автоназначения компании. Закладка доступна в форме редактирования существующей компании.
...
| кнопка *Настроить* | Позволяет перейти к диалогу настройки внешнего вида таблицы со списком правил. |
| *таблица со списком правил* | | Поле | Описание | | --- | --- | | Действия | Действия над правилом:  * **Редактировать** - редактирование параметров правила во всплывающем окне; * **Удалить** - удаление правила. | | ID | Идентификатор правила. | | Сортировка | Относительный "вес" правила. | | Правило | Вид правила. | | Параметры | Параметры правила. | |
