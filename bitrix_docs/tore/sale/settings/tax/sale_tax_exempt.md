...
- [Список ставок налогов](#list)
--!>

Страницв **Освобождение от налогов** (*Магазин > Настройки > Налоги > Освобождение от налогов*) содержит список групп пользователей сайта, освобождаемых от уплаты каких-либо налогов при покупке товара в интернет-магазине.
...
| Налоги | Перечень налогов, от уплаты которых освобождена данная группа пользователей. |
