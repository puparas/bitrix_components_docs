# Настройка освобождения от налогов
...
Данная форма предназначена для редактирования записи об освобождении от уплаты налогов для выбранной группы пользователей.
...
| Группа пользователей | Группы пользователей сайта, к которым применяется освобождение от налогов. |
| Описание группы пользователей | Описание группы пользователей, заданное при создании группы. |
| Освобождение от налогов | Список налогов, от уплаты которых может быть освобождена данная группа пользователей.   Для выбора нескольких налогов удерживайте клавишу *Ctrl*. |
...
| Применить | Применение внесённых изменений. Продолжение редактирования параметров записи. |
...
* [Как освободить покупателя от налогов](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=42&LESSON_ID=12225#tarifs_free)
