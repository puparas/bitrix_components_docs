...
| Действия | Действия над ставками НДС:  * **Редактировать** - [редактирование](/user_help/store/sale/settings/tax/cat_vat_edit.php) ставки НДС; * **Деактивировать** - выключение опции активности (**Акт.**) ставки НДС; * **Удалить** - удаление ставки НДС. |
| ID | Идентификатор ставки НДС в базе данных. |
| Сорт. | Относительный "вес", определяющий положение ставок НДС в общем списке. |
| Акт. | Флаг активности ставок НДС. Только активные ставки могут быть использованы. |
| Наименование | Название ставки НДС. |
