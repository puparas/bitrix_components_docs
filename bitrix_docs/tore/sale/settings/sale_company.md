...
| Действия | Действия над компанией:  * **Изменить** - [редактирование](/user_help/store/sale/settings/sale_company_edit.php) компании; * **Удалить** - удаление компании. |
| ID | Идентификатор компании в системе. |
| Активность | Признак активности компании. Активная компания может использоваться в работе интернет-магазина. |
| Название | Название компании. |
| Расположение | Местоположение компании. |
| Код | Символьный код компании. |

### Смотрите также

* [Компании (учебные курс "Администратор. Бизнес")](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=42&LESSON_ID=7280)
