...
Каждая автоматизированная служба доставки имеет несколько профилей. Форма добавления/редактирования профиля повторяет форму создания/редактирования самой службы. Поэтому описание необходимых вам параметров смотрите на странице [Создание и редактирования службы доставки](/user_help/store/sale/settings/delivery/sale_delivery_service_edit.php).
