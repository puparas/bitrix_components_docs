...
| Список служб доставок | Переход к просмотру [списка служб доставок](/user_help/store/sale/settings/delivery/sale_delivery_service_list.php). |
...
| Действия | Действия над группой:  * **Копировать** - [создание](/user_help/store/sale/settings/delivery/sale_delivery_group_edit.php) новой группы служб доставок путем копирования параметров текущей группы; * **Изменить** - [редактирование](/user_help/store/sale/settings/delivery/sale_delivery_group_edit.php) группы; * **Удалить** - удаление группы. |
