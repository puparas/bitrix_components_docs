...
| Меню действий | Допустимые действия:  * **Редактировать** - переход к [редактированию единицы измерения](/user_help/store/sale/settings/cat_measure_edit.php); * **Удалить** - удаление единицы измерения. |
...
| Условное обозначение | Условное обозначение единицы измерения (национальное). |
...
| По умолчанию | Признак использования единицы измерения по умолчанию.   Единица измерения с признаком **по умолчанию**  автоматически    Проставляется автоматически, если в импортируемом файле не указано иное значение. проставляется при csv-импорте для новых товаров (с версии модуля **Торговый каталог 20.0.100**). |

### Смотрите также

* [Единицы измерения (учебный курс "Администратор. Бизнес")](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=42&LESSON_ID=7058)
