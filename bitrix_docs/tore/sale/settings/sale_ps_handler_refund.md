...
Страница **Настройка возвратов** (*Магазин > Настройки > Платежные системы > Настройка возвратов*) содержит список идентификаторов вашего магазина для различных платежных сервисов. Запись на странице появляется в том случае, если обработчик платежной системы поддерживает настройку возврата, и для него выполнены настройки подключения.

#### Список идентификаторов магазина
...
| Название обработчика | Название обработчика платежной системы. |
| Подключен | Признак подключения механизма возвратов. |

#### Смотрите также:

* [Настройка возвратов (курс "Администратор. Бизнес")](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=42&CHAPTER_ID=09255)
