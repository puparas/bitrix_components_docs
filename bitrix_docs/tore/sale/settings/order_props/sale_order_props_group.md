...
| Действия | Действия над группой свойств заказа:  * **Изменить группу**- [редактирование](/user_help/store/sale/settings/order_props/sale_order_props_group_edit.php) параметров группы свойств; * **Удалить группу**- удаление группы свойств. |
...
| Сорт. | Относительный "вес" группы свойств. Определяет порядок, в котором группы свойств будут выводиться при оформлении заказа. |
| Свойства | Ссылка для перехода к [списку свойств](/user_help/store/sale/settings/order_props/sale_order_props.php), относящихся к данной группе. |
