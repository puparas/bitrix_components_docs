# Создание и редактирование пирамиды
...
| \*Сайт | Сайт, на котором будет реализована пирамида. |
| Комиссия аффилиата *N* уровня | Процент от дохода привлеченного аффилиата *N* уровня (*N* - номер уровня: 1, 2, 3, 4 или 5). |

\* - поля, обязательные для заполнения.

### Смотрите также

* [Пирамида (учебный курс "Администратор. Бизнес")](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=42&LESSON_ID=3201)
