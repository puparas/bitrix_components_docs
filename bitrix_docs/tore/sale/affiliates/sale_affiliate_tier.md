...
| Действия | Действия, доступные для выполнения над пирамидами:  * **Изменить**- [редактирование](/user_help/store/sale/affiliates/sale_affiliate_tier_edit.php) пирамиды; * **Удалить** - удаление пирамиды. |
| ID | Идентификатор пирамиды в системе. |
| Сайт | Сайт, на котором реализована пирамида. |
| Комиссия аффилиата <N> уровня (%) | Процент дохода от привлеченного аффилиата *N* уровня (*N* - номер уровня: 1, 2, 3, 4 или 5). |
