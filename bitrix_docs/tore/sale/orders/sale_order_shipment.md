...
Форма содержит список документов отгрузок, а также значения основных полей этих документов.

| Поле | Описание |
| --- | --- |
| Колонка флажков | Выбор отгрузок, к которым предполагается применить какое-либо правило или действие. |
| Действия | Действия над документом отгрузки:  * **Изменить** - переход к [редактированию документа](/user_help/store/sale/orders/sale_order_shipment_edit.php); * **Удалить** - удаление документа. |
| Дата документа отгрузки | Дата создания документа отгрузки. |
| ID | Идентификатор документа отгрузки. |
...
| Статус отгрузки | Статус отгрузки товаров. |
...
| Служба доставки | Служба, с помощью которой будет выполнена доставка товаров. |
| Стоимость доставки | Стоимость доставки товаров по данному документу отгрузки. |
| Компания | Компания, через которую выполняется отгрузка товара. |
| Номер документа отгрузки | Номер документа отгрузки. |
| Ответственный | Пользователь, ответственный за отгрузку. |
