...
Переход на эту страницу осуществляется, когда на странице заказов выбрано действие отправки транспортных заявок.

На самой странице представлены блоки с логотипами служб доставок и кнопками **Создать новую заявку** и **Добавить в существующую заявку**:

* По кнопке **Создать новую заявку** выполняется создание и отправка новой заявки в службу доставки;
* По кнопке **Добавить в существующую заявку** - добавление отгрузок из выбранных заказов в уже существующую заявку.

**Примечание:** на текущий момент стандартный функционал транспортных заявок поддерживается только для [Почты России](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=42&LESSON_ID=12732).

#### Смотрите также:

* [Транспортные заявки (учебный курс "Администратор. Бизнес")](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=42&LESSON_ID=10483)
