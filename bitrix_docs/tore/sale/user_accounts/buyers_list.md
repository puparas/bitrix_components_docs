...
| Количество полностью оплаченных заказов | Число полностью оплаченных покупателем заказов. |
| Количество частично оплаченных заказов | Число частично оплаченных покупателем заказов. |
| Сумма полученных оплат | Общая сумма оплаченных покупателем заказов. |
| Группы покупателя | Группы пользователей, в которых состоит покупатель. |
