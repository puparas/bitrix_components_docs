...
| Дата транзакции | Дата проведения операции по счету. |
...
| Описание | Регистрационный код, имя и логин пользователя, выполнившего транзакцию. |

### Смотрите также

* [Транзакции (учебный курс "Администратор. Бизнес")](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=42&LESSON_ID=3191)
