...
Данная страница служит для редактирования профиля покупателя.
...
| Профайл | Название профиля покупателя. |
| Личные данные | |
| \*Ф.И.О. | ФИО, используемые в данном профиле покупателя. |
| \*E-Mail | Электронный адрес покупателя, используемый в данном профиле. |
| \*Телефон | Номер телефона покупателя, используемый в данном профиле. |
| Данные для доставки | |
| \*Индекс | Индекс местоположения покупателя. |
| Местоположение | Местоположение покупателя. |
| Город | Город покупателя (если он не задан в поле **Местоположение**) |
...
| Применить | Применение внесённых изменений. Продолжение редактирования профиля покупателя. |
