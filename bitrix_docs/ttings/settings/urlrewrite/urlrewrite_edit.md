...
На данной странице вы можете создать новое или изменить параметры существующего правила обработки адресов.
...
| Добавить | Переход на страницу с формой создания нового правила обработки адресов.  Кнопка отображается при редактировании существующего правила обработки адресов. |
...
| Компонент | Указывается полное имя компонента (*пространство\_имен:имя\_компонента*), для которого будет работать правило. |
