...
Форма **Модули** (*Настройки > Настройки продукта > Модули*) служит для инсталляции и деинсталляции модулей системы. Например, если не используется модуль **Документооборот**, то вы можете его деинсталлировать, чтобы он не занимал ресурсы компьютера и место в меню. Позднее вы сможете инсталлировать его вновь (дистрибутив модуля сохраняется в системе).

| Поле | Описание |
| --- | --- |
| Название | Название модуля. |
| Версия | Текущая версия модуля. |
| Дата обновления | Дата последнего обновления модуля. |
| Статус | Текущий статус модуля:  * **Установлен**; * **Не установлен**. |
| Действия | Доступные действия над модулем:  * **Удалить**; * **Установить**. |
...
**Примечание:** некоторые модули поддерживают веб-кластеры и при установке имеют опцию выбора базы данных.
