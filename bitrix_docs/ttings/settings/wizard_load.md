...
С помощью формы **Импорт мастера** осуществляется загрузка мастера в систему.
...
| Поле | Описание |
| --- | --- |
| Файл с мастером для загрузки (\*.gz) | С помощью кнопки **Обзор...** выбирается файл с мастером (формат **\*.gz**) для загрузки. |
