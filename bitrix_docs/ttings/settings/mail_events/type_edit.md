# Создание и редактирование типа почтового события
...
Форма предназначена для создания нового или изменения уже существующего типа почтового или СМС события.
...
| Добавить тип | Переход к форме создания нового типа события.   Кнопка отображается при редактировании существующего типа события. |
| Удалить тип | Удаление редактируемого типа.   Кнопка отображается при редактировании существующего типа сообытия. |
| Список шаблонов | Переход к списку шаблонов, привязанных к редактируемому типу.   Кнопка отображается при наличии шаблонов, привязанных к типу. |
...
| Вид события | Выбирается вид: почтовое событие или СМС-событие. |
| Для каждого из установленных в системе языков: | |
| ID | Указывается идентификатор типа события для каждого из языков. |
| Сортировка | Задается индекс сортировки, определяющий положение типа события в общем списке. |
| Название | Указывается осмысленное название типа события. |
...
| Шаблоны | |
| --- | --- |
| На данной закладке выводятся все почтовые или СМС шаблоны, привязанные к данному типу:  * идентификатор шаблона, представленный в виде ссылки на форму редактирования данного шаблона; * название шаблона; * сайт (или сайты), для отправки почтовых или СМС сообщений с которого используется данный шаблон. | |
