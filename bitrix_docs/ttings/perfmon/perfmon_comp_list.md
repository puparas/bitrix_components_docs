...
На странице **Компоненты** (*Настройки > Производительность > Компоненты*) можно просмотреть отчет по используемым на страницах сайта компонентам или включаемым областям.

  

### Фильтр

Форма фильтра используется для фильтрации записей о компонентах в соответствии с указанными условиями. Нижеследующая таблица описывает параметры, по которым могут выбираться записи.
...
| Компонент | Позволяет найти запись по имени компонента или адреса файла включаемой области. |
| Хит | Позволяет найти компоненты, подключенные на странице, по идентификатору хита. |
| Страница | Позволяет найти запись по названию страницы. |
...
| Компонент | Имя компонента или адрес файла включаемой области. |
| Время | Время, затраченное на подключение. |
| Запросы | Количество выполненных запросов к базе данных. |
| Запросы-время | Время исполнения запросов к базе данных. |
| Кеширование | Тип кеширования компонента. |
