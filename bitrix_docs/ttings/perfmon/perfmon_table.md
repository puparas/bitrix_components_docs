...
На странице **Таблицы в базе данных** (*Настройки > Производительность > Таблицы*) можно просмотреть таблицы базы данных.

При переходе по ссылке с именем таблицы в списке откроется страница, содержащая подробную информацию таблицы.

Подробнее работа с таблицами описана в уроке [Таблицы в базе данных](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=5129) курса Администратор. Базовый.
