...
| Статус | * - индекс создан * - индекс не будет создаваться |
| Таблица | Таблица к которой обращается запрос. |
| Колонка | Колонка таблицы к которой обращается запрос. |
| Индекс | Название индекса, либо уведомление **Не предлагать создавать**. |
