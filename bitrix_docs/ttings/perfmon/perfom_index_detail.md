...
Форма детального анализа запроса.
...
| Статистика таблицы | Название, размер и количество строк в таблице. |
...
| --- | --- |
| Запрос | Текст запроса. |
| \_имя колонки\_ | Колонка таблицы, к которой обращается запрос и процент выборки данных. |
...
| --- | --- |
| Запрос | Текст запроса. |
| План исполнения до создания индекса | Таблица с планом исполнения и средним временем запроса. |
| Индекс | * Запрос на создание индекса (для использования в консоли); * **Создать индекс** - кнопка создания предлагаемого индекса; * **Больше не предлагать создавать** - отказ от создания, больше система не будет предлагать создание индекса по этому запросу.  После создания индекса появится кнопка **Удалить индекс** и раздел **План исполнения после создания индекса**. |
