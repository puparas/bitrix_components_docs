...
На странице **Сервер БД** (*Настройки > Производительность > Сервер БД*) отображается сводная статистика производительности сервера базы данных.

Если значения показателей отличаются от рекомендованных, то их можно скорректировать с помощью инструментов [Проверка БД](/user_help/settings/perfmon/repair_db.php) и/или [SQL запрос](/user_help/settings/utilities/sql.php).
