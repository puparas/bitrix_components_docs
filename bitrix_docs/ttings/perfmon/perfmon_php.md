...
На странице **Настройки PHP** (*Настройки > Производительность > PHP*) отображается сводная таблица **Параметры окружения** с анализом параметров PHP.

С помощью ссылки **Настройки PHP** открывается страница с подробной информацией о **PHP**.
