...
Страница **Список лицензируемых серверов веб-кластера** (Настройки > Веб-кластер > Лицензирование) содержит информацию о лицензируемых серверах веб-кластера.

Лицензируются только сервера в редакциях "Энтерпрайз по подписке". В обычном коробочном "Энтерпрайз" количество серверов не ограничено.
