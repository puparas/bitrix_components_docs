...
Форма настроек модуля **Облако 1С-Битрикс** (*Настройки > Настройки продукта > Настройки модулей > Облако 1С-Битрикс*) предназначена для задания общесистемных параметров модуля.

#### Закладка Настройки

| Поле | Описание |
| --- | --- |
| Интервал расчётов | Указывается период времени, который будет использован для расчета и отображения информации на странице [Инспектор сайтов](/user_help/settings/bitrixcloud/bitrixcloud_monitoring_admin.php) (*Настройки > Облако 1С-Битрикс > Инспектор сайтов*).    **Примечание:** Период будет изменен не сразу из-за кеширования. |
