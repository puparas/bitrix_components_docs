...
Страница **Настройки PHP** (*Настройки > Инструменты > Настройки PHP*) служит для отображения информации о текущих настройках **PHP**. Для получения информации используется функция **phpinfo()**.
