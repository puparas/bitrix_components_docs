...
Сдача проекта осуществляется прохождением автоматических и ручных тестов **Монитора качества**.

#### Смотрите также:

* [Монитор качества](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&CHAPTER_ID=04830)
