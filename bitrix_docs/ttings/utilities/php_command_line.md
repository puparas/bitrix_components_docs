...
- [Закладка "PHP-строка"](#form)
- [Кнопки управления](#buttons)
--!>

Страница **Командная PHP-строка** (*Настройки > Инструменты > Командная PHP-строка*) предназначена для задания PHP-скрипта, который будет выполнен на сервере.

**Примечание**: при написании неверного запроса к БД в командной строке выводится SQL-ошибка (с версии 11.0.9 ).
...
| Очистить | Очистка поля для создания нового скрипта. |
