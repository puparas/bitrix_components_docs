...
**Примечание:** Для того чтобы сканер имел возможность проводить статический анализ уязвимостей необходимо, чтобы в системе было установлено и включено PHP расширение [tokenizer](http://www.php.net/manual/ru/book.tokenizer.php).
...
* [Сканер безопасности (учебный курс "Администратор. Базовый")](https://dev.1c-bitrix.ru/learning/course/?COURSE_ID=35&CHAPTER_ID=05294&LESSON_PATH=3906.4829.4547.5294)
