...
- [Закладка "Защита административной части"](#security_iprule_admin)
- [Кнопки управления](#buttons)
--!>

Защита административной части сайта осуществляется с помощью ограничения доступа со всех, кроме указанных в настройках IP-адресов и диапазонов адресов.

  

### Закладка Защита административной части

Включение или отключение защиты выполняется на странице **Защита административной части** (*Настройки > Проактивная защита > Защита административного раздела*) с помощью кнопки **Включить защиту** (**Выключить защиту**).
...
* [Сбросить защиту админки по IP](https://dev.1c-bitrix.ru/community/forums/messages/forum6/topic26778/message147764/#message147764)
