...
Поиск троянов (23.0.0)

# Поиск троянов

Инструмент **Поиск троянов** запускает скрипт, который сканирует сайт в поисках определённых шаблонов потенциально вредоносного кода и формирует список подозрительных файлов. Подробнее читайте [в уроке](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=26614) учебного курса «Администратор. Базовый».
