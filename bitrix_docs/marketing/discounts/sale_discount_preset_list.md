...
На странице **Предустановленный список маркетинговых акций** (*Маркетинг > Товарный маркетинг > Предустановленный список маркетинговых акций*) представлены блоки пресетов для создания скидок на товары, доставку и оплату.

В каждом блоке имеется кнопка **Создать**, с помощью которой запускается [мастер создания скидки](/user_help/marketing/discounts/sale_discount_preset_detail.php). Кнопка **Список** служит для перехода на страницу со [списком правил корзины](/user_help/marketing/discounts/sale_discount.php), отфильтрованным по выбранному пресету скидки.
