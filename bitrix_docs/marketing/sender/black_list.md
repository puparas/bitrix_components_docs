...
| Удалить из черного списка | Позволяет удалить адрес/телефон из черного списка. |
...
| Меню действий | Отображение меню, позволяющее **Удалить из черного списка** адрес получателя рассылки. |
| ID | Идентификатор адреса пользователя, под которым он зарегистрирован в базе данных. |
| Добавлен | Отображается дата добавления адреса в черный список. |
| Тип | Указывается тип адреса (e-mail адрес или телефон). |
| Email / Телефон | Email адрес или номер телефона получателя рассылки. |
| Имя | Имя адресата. |
