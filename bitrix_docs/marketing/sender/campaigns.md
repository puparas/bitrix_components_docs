...
| Удалить | Служит для удаления созданных кампаний. |
...
| Меню действий | Отображение меню, позволяющего **Удалить**  или **Редактировать** сегмент. |
| ID | Идентификатор кампании, под которым она зарегистрирована в базе данных. |
| Создан | Дата создания кампании. |
| Название | Название кампании. |
| Активная | Статус действия кампании в настоящее время. |
| Публичная | Степень открытости кампании. |
| Сайт | Сайт, на котором действует кампания. |
