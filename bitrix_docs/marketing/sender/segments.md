...
| Удалить | Служит для удаления созданных сегментов. |
...
| Меню действий | Отображение меню, позволяющего **Редактировать**, **Копировать** или **Удалить** сегмент. |
| Название | Название сегмента. |
| Использовался | Дата последнего использования сегмента. |
| Получателей | Количество адресов получателей рассылки. |
| Статус | Статус сегмента рассылки. |
