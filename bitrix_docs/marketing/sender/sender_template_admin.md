...
| Удалить | Служит для удаления созданного шаблона. |
...
| Меню действий | Отображение меню, позволяющее **Редактировать** или **Удалить** шаблон выпуска рассылки. |
| ID | ID шаблона. |
| Дата | Дата создания шаблона. |
| Дата использования | Дата последнего использования шаблона. |
| Название | Название шаблона. |
| Использовался | Сколько раз использовался шаблон. |
