...
- [Форма создания черного списка](#creation_form)
- [Кнопки управления](#buttons)
--!>

Форма создания черного списка открывается при нажатии кнопки **Добавить в список** в разделе **Черный список** (*Маркетинг > Email-маркетинг > Черный список*)

#### Форма создания черного списка
