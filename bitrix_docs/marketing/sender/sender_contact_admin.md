...
| Наборы адресов | Позволяет перейти к [редактированию](/user_help/marketing/sender/editing_sets.php) наборов адресов. |
...
| Меню действий | Отображение меню, позволяющего **Редактировать**, **Удалить из черного списка**, **Удалить** адрес получателя рассылки, либо просмотреть **Рассылки**, которые ему были отправлены. |
| ID | ID адреса. |
| Добавлен | Дата добавления адресата в список. |
| Тип | Отображение типа адреса: либо e-mail адрес, либо телефон. |
| Email / Телефон | Email адрес или телефон получателя. |
| Имя | Имя адресата. |
| Статистика | Просмотр статистики активности пользователя (прочитал, кликнул, отписался и т.д.). |
