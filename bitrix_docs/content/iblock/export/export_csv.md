...
| Имя файла данных относительно корня сайта | Полное имя файла (путь к файлу указывается относительно корня сайта), в который будут выгружены данные из инфоблока. Например, /upload/export\_file.csv. **Важно!** Если файл с указанным именем уже существует, то он будет перезаписан. |
...
* [Экпорт инфоблока в формате CSV](/learning/course/index.php?COURSE_ID=34&LESSON_ID=1999)
