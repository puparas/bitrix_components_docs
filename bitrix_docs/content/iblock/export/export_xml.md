...
[Экспорт в формате CSV](/user_help/content/iblock/export/export_csv.php)
[Экспорт в формате XML](/user_help/content/iblock/export/export_xml.php)
...
Форма **Экспорт XML** (*Контент > Инфоблоки > Экспорт > XML*) предназначена для [экспорта данных](http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=2001) из инфоблока в XML файл.
...
| Информационный блок | Указывается тип и собственно информационный блок, который необходимо экспортировать. |
...
| Разделы | Выбор разделов по статусам, которые нужно выгружать. |
| Элементы | Выбор элементов по статусам, которые нужно выгружать. |

При нажатии на кнопку **Экспортировать** начинается экспорт инфоблока и над формой настроек отображается ход процесса выгрузки. Кнопка **Остановить экспорт** служит для остановки процесса выгрузки информационного блока в случае необходимости. После завершения операции выводится соответствующее сообщение.
