# Фотогалерея 2.0. Настройки модуля
...
[Фотогалерея 2.0. Настройки модуля](/user_help/content/iblock/photogallery/settings.php)
...
Форма настроек модуля **Фотогалерея 2.0** (*Настройки > Настройки продукта > Настройки модулей > Фотогалерея 2.0*) предназначена для задания общесистемных параметров модуля.
...
| Дополнительные эскизы | В данной секции задаются параметры дополнительных эскизов: указываются произвольные **Название**, **Код**, **Размер (px)** и **Качество (%)** эскиза.  В результате, если в компоненте выбран дополнительный эскиз, то при загрузке картинки будет создана дополнительная копия картинки указанного размера и просмотр списка фотографий альбома будет возможен в нескольких вариантах. **Примечание:** код эскиза не может начинаться с цифры. |
...
| Применить | Сохранить внесённые изменения и остаться на текущей странице. |
