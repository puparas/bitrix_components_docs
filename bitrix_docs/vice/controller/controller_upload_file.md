...
Страница **Передача файла** (*Сервисы > Контроллер > Передача файла*) служит для передачи файлов на сайты.
...
| Группа | Выбирается группа, на сайт (сайты) которой должен быть передан файл. |
...
| Куда | Для выбранного в фильтре сайта-клиента указывается директория, в которую должен быть отправлен файл. |

#### Смотрите также:

* [Передача файла (учебный курс "Администратор. Модули")](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2912)
