...
| Меню действий | При нажатии на кнопку действий конкретной группы отображается меню, позволяющее:  * **Редактировать** - отредактировать [группу сайтов](/user_help/service/controller/controller_group_edit.php); * **Копировать**- создать новую группу, повторяющую настройки выбранной группы. * **Удалить** - удалить группу. **Примечание**: удаление группы, к которой относится хотя бы один сайт, а также группы, используемой по умолчанию, невозможно. |
| Название | Название группы. |
| Дата изменения | Дата и время проведения последней модификации группы. |
| Кем изменено | Логин, имя и фамилия пользователя, проводившего последнее изменение группы. |
| Дата создания | Дата и время создания группы сайтов. |
| Кем создана | Логин, имя и фамилия пользователя, создавшего группу. |
| Описание | Произвольное описание группы сайтов. |
| Период обновления счетчиков | Период времени, через которое происходит обновление счетчика. |
| Обновлять счетчик св. места | Признак обновления счетчика свободного дискового пространства. |
| Обновлять счетчик сайтов | Признак обновления счетчика количества сайтов. |
| Обновлять счетчик пользователей | Признак обновления счетчика пользователей. |
