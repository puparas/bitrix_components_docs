...
| Изменённое поле | Какое поле было изменено. |
| Пользователь | Логин, имя и фамилия пользователя, проводившего последнее изменение клиента. |
| Начальное значение | Начальное значение поля. |
| Новое значение | Новое значение поля. |
| Примечание | Примечание по совершенному действию. |

### Смотрите также

* [Журнал и история сайта (учебный курс "Администратор. Модули")](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2889)
