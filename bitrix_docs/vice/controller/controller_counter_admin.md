...
| Меню действий | Доступные действия:  * **Редактировать** - отредактировать параметры счётчика; * **Удалить** - удаление счётчика. |
| Название | Название счётчика. |
| Тип данных | В каком типе данных выводятся данные счетчика. |
