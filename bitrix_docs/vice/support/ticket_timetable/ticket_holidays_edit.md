...
Форма предназначена для создания нового или редактирования параметров уже существующего исключения.
...
| Удалить | Удаление редактируемого исключения. |
...
| Действие | Выбирается действие исключения: один из видов выходного или работы. |
...
| Описание | Произвольное описание исключения. |
