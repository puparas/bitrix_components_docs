...
Форма предназначена для создания нового или редактирования параметров уже существующего купонов спецобращений.
...
| Купон активен с даты | Указывается дата начала активности купона. |
| Купон активен по дату | Указывается дата окончания активности купона. |
| Активность | При отмеченной опции купон будет активен в течение периода, заданного с помощью вышеуказанных полей. |
| Количество оставшихся использований | Указывается количество, которое купон может быть еще использован. |
| Уровень поддержки | С помощью выпадающего списка задается уровень техподдержки, к которому будет отнесено созданное с использованием купона обращение. |
