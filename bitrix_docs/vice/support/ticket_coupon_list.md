...
На странице **Купоны спецобращений** (*Сервисы > Техподдержка > Купоны спецобращений*) представлена информация о купонах спецобращений. Обращения с купонами помещаются в начале списка обращений. Формат для генерации купонов задается в [настройках модуля Техподдержка](/user_help/service/support/settings.php).

  

### Фильтр

Форма фильтра используется для выбора из списка купонов в соответствии с указанными условиями. Нижеследующая таблица описывает параметры, по которым может выполняться поиск.

| Параметр | Описание |
| --- | --- |
| Купон | Поиск купона по его коду. |
| ID | Поиск купона по идентификатору. |
...
| Меню действий | Действия, которые можно произвести над купоном:  * **Редактировать купон** - переход к [форме редактированию параметров купона](/user_help/service/support/ticket_coupon_edit.php); * **Удалить** - удаление купона; * **Журнал использования** - переход в [журнал](/user_help/service/support/ticket_coupon_log.php) для просмотра информации об использовании данного купона. |
...
| Использован, раз | Количество использований купона. |
| Дата изменения | Время и дата изменения купона. |
| Дата создания | Время и дата создания купона. |
| Активность | Признак активности купона. |
| Активен с | Дата начала активности купона. |
| Активен по | Дата окончания активности купона. |
| ID создавшего пользователя | Личная информация создавшего купон пользователя. |
| Login создавшего пользователя |
| Имя создавшего пользователя |
| Фамилия создавшего пользователя |
| ID обновившего пользователя | Личная информация обновившего купон пользователя. |
| Login обновившего пользователя |
| Имя обновившего пользователя |
| Фамилия обновившего пользователя |
| ID уровня поддержки | Идентификатора уровня техподдержки, который применяется к обращению при использовании купона. |
| Уровень поддержки | Уровень техподдержки, который применяется к обращению при использовании купона. |

### Смотрите также

* [Спецобращения (учебный курс "Администратор. Модули")](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=5337)
