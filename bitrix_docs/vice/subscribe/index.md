...
При решении задач по рассылке достаточно часто бывает необходимо настроить серверную утилиту **cron**. Описание способов настройки сторонних приложений не входит в задачи документации по "1С-Битрикс: Управление сайтом". О параметрах настройки этой утилиты можно узнать [здесь](http://www.rhd.ru/docs/manuals/enterprise/RHEL-AS-2.1-Manual/custom-guide/cron-task.html), например.
