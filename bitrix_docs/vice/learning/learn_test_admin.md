...
| Меню действий | Допустимые действия:  * **Изменить** - [отредактировать](/user_help/service/learning/learn_test_edit.php) тест; * **Удалить** - удалить тест. |
| ID | Идентификатор теста. |
| Дата изм. | Дата и время последней модификации теста. |
| Название | Название теста. |
| Сорт. | Вес сортировки теста; применяется при выводе теста в списке. |
| Акт. | Признак активности теста. |
| Кол-во попыток (успешных/всего) | Указывается количество **успешных** из **всех** попыток. Ссылки на количествах ведут на [страницы попыток](/user_help/service/learning/learn_attempt_admin.php) с фильтром на соответствующие попытки. |
