...
| Период активности | Начало и окончание активности учебной группы. |
...
| Индекс сортировки | Вес сортировки группы. |
| График открытия разделов\* | |
| Задержка перед открытием (в днях) | Для каждой главы/урока верхнего уровня указывается через сколько дней после начала активности группы она/он станет доступной/доступным. |
| Членство в группе | |
| Состав учебной группы | Выбираются пользователи-участники учебной группы. |
...
| Применить | Сохранение внесённых изменений. Продолжение редактирования учебной группы. |
| Отменить | Отмена внесённых изменений. Возврат к [списку учебных групп](/user_help/service/learning/learn_group_admin.php). |
