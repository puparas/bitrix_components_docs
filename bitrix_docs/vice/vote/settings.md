# Опросы, голосования. Настройки модуля
...
Форма настроек модуля **Опросы, голосования** (*Настройки > Настройки продукта > Настройки модулей > Опросы, голосования*) предназначена для задания параметров модуля.
...
| Поддерживать старые шаблоны (default.php, bluebar.php) в форме редактирования вопросов | При отмеченной опции будут поддерживаться старые шаблоны в форме редактирования вопросов. |
...
| [группа\_пользователей] | Изменение настроек доступа для конкретной группы. Возможно назначение следующих прав доступа к модулю **Опросы, голосования**:  * **[D] закрыт** - запрет на доступ; * **[R] просмотр всех данных модуля** - разрешается только просмотр всех данных модуля; * **[W] запись** - полный доступ к ресурсам модуля. |
