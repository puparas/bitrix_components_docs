...
| Меню действий | Меню, позволяющее **удалить** запись о посетителе. |
| ID | Идентификатор посетителя в модуле **Опросы**. |
| Первый | Дата первого голосования посетителя. |
| Последний | Дата последнего голосования посетителя. |
| Посетитель | Идентификатор, логин, имя и фамилия авторизованного пользователя, а также идентификатор пользователя в модуле **Статистика**. |
| IP | IP-адрес, с которого голосовал пользователь. |
| Голосований | Количество голосований посетителя. |
