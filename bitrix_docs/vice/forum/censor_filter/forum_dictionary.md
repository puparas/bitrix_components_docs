# Список словарей нецензурных слов/транслита
...
На странице **Словарь нецензурных слов** (*Сервисы > Форумы > Фильтр нецензурных слов > Словарь нецензурных слов* ) представлен список словарей нецензурных слов.
...
| Действия | Действия, которые можно применить к элементу списка:  * **Изменить** - переход на форму [редактирования словаря](/user_help/service/forum/censor_filter/forum_dictionary_edit.php); * **Удалить** - удаление словаря. |
| ID | Идентификатор словаря. |
| Название | Название словаря. |
