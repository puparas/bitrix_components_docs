# Создание/редактирование записи словаря транслита
...
Форма используется для добавления новой записи в словарь транслита.
...
| \*Буква | Написание новой буквы. |
| Замена | Содержимое этого поля будет заменять вышеуказанную букву. |
