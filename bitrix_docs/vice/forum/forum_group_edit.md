...
Форма используется для создания и редактирования групп форумов, предназначенных для группировки форумов в публичной части сайта.
...
| Создать новую группу | Переход к форме создания новой группы форумов. Кнопка отображается при редактировании существующей группы. |
...
| Сортировка | Относительный "вес", определяющий положение группы в списке. Чем меньше значение, тем выше в списке показывается группа. |
...
| Описание | Произвольное описание группы для каждого языка. |

\* - Поля, обязательные для заполнения.

### Смотрите также

* [Группы форумов (учебный курс "Администратор. Модули")](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2963)
