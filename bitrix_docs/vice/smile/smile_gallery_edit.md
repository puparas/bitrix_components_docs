# Добавление и редактирование галереи
...
| Добавить новую | Открытие формы создания галереи. (Доступно только при редактировании галереи.) |
...
| --- | --- |
| Название галереи | |
| Язык | Название галереи на определённом языке. Должны быть дано название как минимум для языка интерфейса административной части. В противном случае система присвоит набору название вида: **Галерея\***. |
| Дополнительные данные | |
| Сортировка | Индекс сортировки, определяющий положение галереи в общем списке. |
| Код галереи | Осмысленное кодовое название галереи. |
| Смайлы из галереи | Отображение первых десяти смайлов. |
