...
### Описание **landing.domains**

Компонент служит для вывода списка доменов.
Компонент является стандартным и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *Сайты 24 > Список доменов.*
...
| Ссылка на редактирование домена | **PAGE\_URL\_DOMAIN\_EDIT** | Указывается адрес страницы, на которой выполняется редактирование домена. |  |
