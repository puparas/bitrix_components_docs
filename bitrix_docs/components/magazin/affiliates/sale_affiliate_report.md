...
Одностраничный компонент, отображающий список проданных товаров от авторизованного аффилиата за установленный период времени.

### Описание **sale.affiliate.report**

Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути: *Магазин > Аффилиаты > Отчет по программе аффилиата*.
...
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции в качестве заголовка страницы будет установлено **Отчет по программе**. |
