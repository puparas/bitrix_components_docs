...
С версии модуля sale 17.0.9 заменяет компонент [sale.gift.section](/user_help/components/magazin/information_tovars/sale_gift_section.php)
