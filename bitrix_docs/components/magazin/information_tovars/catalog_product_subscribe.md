...
### Описание **catalog.product.subscribe**

Компонент служит для отображения формы подписки на товар. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *Магазин > Информация о товарах > Подписка на товары*.
...
| CSS класс кнопки подписки | **BUTTON\_CLASS** | CSS класс для кнопки подписки. |
