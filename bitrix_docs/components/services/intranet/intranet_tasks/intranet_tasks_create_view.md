...
### Описание **intranet.tasks.create\_view**
...
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции на каждой странице будет установлен заголовок:  * **<*имя\_пользователя*> : Создание нового представления** или **<*имя\_группы*> : Создание нового представления**; * **<*имя\_пользователя*> : Изменение представления** или **<*имя\_группы*> : Изменение представления**. |
