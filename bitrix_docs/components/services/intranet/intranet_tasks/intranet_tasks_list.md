...
| **Шаблоны ссылок** | | |
| Путь к списку задач группы | **PATH\_TO\_GROUP\_TASKS** | Указывается путь к списку задач группы. |
...
| Путь к задаче пользователя | **PATH\_TO\_USER\_TASKS\_TASK** | Указывается путь к задаче пользователя. |
...
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции на каждой странице будет установлен заголовок **<*имя\_пользователя*> : Задачи** или **<*имя\_группы*> : Задачи**. |
