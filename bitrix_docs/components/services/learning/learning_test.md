...
### Описание **learning.test**

Компонент отображает контрольный тест курса. Компонент является стандартным и входит в дистрибутив модуля.
...
| Идентификатор теста | **TEST\_ID** | Указывается идентификатор теста. |
| **Шаблоны ссылок** | | |
| URL, ведущий на страницу с результатами тестирования | **GRADEBOOK\_TEMPLATE** | Указывается путь к странице с результатами тестирования (путь к журналу). |
