...
Компонент служит для организации видеозвонка пользователю. Компонент является стандартным и входит в дистрибутив модуля.
...
| ID пользователя | **USER\_ID** | Параметр содержит код, в котором передается идентификатор пользователя видеозвонка. |
| **Шаблоны ссылок** | | |
| Шаблон пути к видеозвонку | **PATH\_TO\_VIDEO\_CALL** | Указывается шаблон пути к видеозвонку. |
