...
Подраздел предназначен для централизованного управления любым количеством независимых веб-сайтов, созданных на платформе «1С-Битрикс: Управление сайтом». Включает в себя следующие компоненты:
...
| [Список сайтов](/user_help/components/services/controller/controller_site_list.php) | **controller\_site\_list** | Выводит список сайтов, зарегистрированных в контроллере. |
