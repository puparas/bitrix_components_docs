...
Компонент выводит форму инициализации регистрации, созданную в рамках социальной сети. Компонент стандартный и входит в дистрибутив модуля.

В структуре визуального редактора компонент расположен по пути *Служебные > Пользователь > Форма инициализации регистрации*.
...
| Название переменной, в которой передается контрольная строка | **CHECKWORD** | Параметр содержит код, в котором передается контрольная строка. |
