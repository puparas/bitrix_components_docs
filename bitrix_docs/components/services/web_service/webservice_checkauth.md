...
### Описание **webservice.checkauth**

Компонент возвращает данные по пользователю, если он правильно авторизован.
...
Компонент не имеет параметров для настройки.

### Пример вызова

```
<?$APPLICATION->IncludeComponent("bitrix:webservice.checkauth","",Array(
	)
);?>
