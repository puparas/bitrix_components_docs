...
### Описание **forum.rules**

Компонент служит для создания страницы с правилами форума. Компонент стандартный и входит в дистрибутив модуля.
...
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции в качестве заголовка страницы будет установлено **Правила форума**. |
