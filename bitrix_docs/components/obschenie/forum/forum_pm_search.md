...
### Описание **forum.pm.search**

Компонент служит для вывода формы поиска пользователя. Компонент стандартный и входит в дистрибутив модуля.
...
| Количество найденных пользователей на странице | **PM\_USER\_PAGE** | Указывается количество найденных пользователей, отображаемых на одной странице. Все найденные пользователи будут выведены с помощью постраничной навигации. |
