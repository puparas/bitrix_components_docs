...
### Описание **blog.user.group**

Компонент позволяет редактировать группы пользователей блога. Компонент стандартный и входит в дистрибутив модуля.

В структуре визуального редактора компонент расположен по пути *Общение > Блоги > Группы пользователей блога*.
...
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции в качестве заголовка страницы будет установлено **Группы пользователей блога "<название\_блога>"**. |
