...
### Описание **blog.group.blog**

Компонент выводит блоги группы. Компонент стандартный и входит в дистрибутив модуля.

В структуре визуального редактора компонент расположен по пути *Общение > Блоги > Блоги группы*.
...
| **Источник данных** | | |
| Идентификатор группы | **ID** | Указывается код, в котором передается идентификатор группы блога. |
| **Внешний вид** | | |
| Количество блогов, выводимых на страницу | **BLOG\_COUNT** | Указывается количество блогов, отображаемых на странице. |
...
| Показывать блоги без сообщений | **SHOW\_BLOG\_WITHOUT\_POSTS** | [Y|N] При отмеченной опции будут показаны блоги, которые не имеют сообщений. |
...
| Шаблон пути к странице с сообщением блога | **PATH\_TO\_POST** | Указывается путь к странице детального просмотра сообщения блога. |
...
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции в качестве заголовка страницы будет установлено **<имя\_группы>** блогов. |
