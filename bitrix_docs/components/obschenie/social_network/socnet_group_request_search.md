...
### Описание **socialnetwork.group\_request\_search**

Компонент позволяет пригласить пользователей в группу социальной сети. Компонент является стандартным и входит в дистрибутив модуля.
...
| **Внешний вид** | | |
| Количество записей в списках | **ITEMS\_COUNT** | Указывается количество приглашение в группу, отображаемых на одной странице. Все приглашения будут выведены с помощью постраничной навигации. |
| **Шаблоны ссылок** | | |
...
| Устанавливать цепочку навигации | **SET\_NAVCHAIN** | [Y|N] При отмеченной опции в цепочку навигации будет добавлен пункт **Приглашение в группу**. |
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции на странице в качестве заголовка будет установлено **<имя\_группы> : Приглашение в группу**. |
| **Имена переменных** | | |
