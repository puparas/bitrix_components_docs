...
### Описание **socialnetwork.events**

Компонент позволяет показать события: новое сообщение, запрос на добавление в список друзей и пр. социальной сети. Компонент является стандартным и входит в дистрибутив модуля.
...
| Шаблон пути к странице чата | **PATH\_TO\_MESSAGES\_CHAT** | Задается путь к странице чата социальной сети. |
