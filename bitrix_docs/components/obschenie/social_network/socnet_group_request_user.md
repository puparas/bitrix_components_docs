# Форма приглашения пользователя вступить в группу
...
### Описание **socialnetwork.group\_request\_user**

Компонент служит для создания формы, с помощью которой отправляется приглашение пользователю вступить в группу социальной сети. Компонент является стандартным и входит в дистрибутив модуля.
...
| Устанавливать цепочку навигации | **SET\_NAVCHAIN** | [Y|N] При отмеченной опции в цепочку навигации будет добавлен пункт **Приглашение вступить в группу**. |
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции на странице в качестве заголовка будет установлено **<пользователь> : Приглашение вступить в группу**. |
| **Имена переменных** | | |
