...
### Описание **socialnetwork.user\_birthday**

Компонент выводит ближайшие дни рождения друзей пользователя социальной сети. Компонент является стандартным и входит в дистрибутив модуля.
...
В визуальном редакторе компонент расположен по пути *Общение > Социальная сеть > Дни рождения друзей*.
...
| **Внешний вид** | | |
| Количество записей в списках | **ITEMS\_COUNT** | Указывается количество записей о ближайших днях рождениях друзей пользователя, которые будут отображены. |
| **Шаблоны ссылок** | | |
