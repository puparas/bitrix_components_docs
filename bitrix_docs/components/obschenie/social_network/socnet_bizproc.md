...
### Описание **socialnetwork.bizproc**

Компонент выводит задания и историю по бизнес-процессам. Компонент является стандартным и входит в дистрибутив модуля.

Компонент относится к модулю [Социальная сеть](/user_help/service/socialnetwork/index.php).

В визуальном редакторе компонент расположен по пути *Общение > Социальная сеть > Бизнес-процессы*.
...
| **Шаблоны ссылок** | | |
| Шаблон пути к обработке задания | **PATH\_TO\_BIZPROC\_EDIT** | Задается путь к странице обработки задания бизнес-процесса. |
...
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции на странице в качестве заголовка будет установлено **Бизнес-процессы**. |
