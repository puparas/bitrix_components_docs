...
### Описание **socialnetwork.features**

Компонент позволяет настраивать функционал пользователей и рабочих групп социальной сети. Компонент является стандартным и входит в дистрибутив модуля.
...
| Устанавливать цепочку навигации | **SET\_NAV\_CHAIN** | [Y|N] При отмеченной опции в цепочку навигации будет добавлен пункт **Настройки пользователя** или **Настройки группы**. |
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции на странице в качестве заголовка будет установлено **<пользователь> : Настройки пользователя** или **<имя\_группы> : Настройки группы**. |
| **Имена переменных** | | |
