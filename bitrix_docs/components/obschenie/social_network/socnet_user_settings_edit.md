...
### Описание **socialnetwork.user\_settings\_edit**

Компонент позволяет настраивать разрешения пользователя (приватность) социальной сети. Компонент является стандартным и входит в дистрибутив модуля.
...
| Устанавливать цепочку навигации | **SET\_NAVCHAIN** | [Y|N] При отмеченной опции в цепочку навигации будет добавлен пункт **Приватность пользователя**. |
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции на странице в качестве заголовка будет установлено **Приватность пользователя**. |
| **Имена переменных** | | |
