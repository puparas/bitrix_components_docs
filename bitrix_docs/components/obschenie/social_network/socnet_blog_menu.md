...
### Описание **socialnetwork.blog.menu**

Компонент выводит меню блогов социальной сети. Компонент является стандартным и входит в дистрибутив модуля.

Компонент относится к модулю [Социальная сеть](/user_help/service/socialnetwork/index.php).

В визуальном редакторе компонент расположен по пути *Общение > Социальная сеть > Меню сообщений*.
...
| **Шаблоны ссылок** | | |
| Шаблон пути к главной странице сообщений | **PATH\_TO\_BLOG** | Указывается путь к главной странице блога. |
| Шаблон пути к недописанным сообщениям | **PATH\_TO\_DRAFT** | Указывается путь к недописанным сообщениям социальной сети. |
| Шаблон пути к странице редактирования сообщения | **PATH\_TO\_POST\_EDIT** | Указывается путь к странице редактирования сообщения блога социальной сети. |
| Шаблон пути к странице пользователя | **PATH\_TO\_USER** | Указывается путь к странице пользователя блога социальной сети. |
...
| Имя переменной для идентификатора сообщения | **POST\_VAR** | Указывается имя переменной, которой передается идентификатор сообщения блога. |
