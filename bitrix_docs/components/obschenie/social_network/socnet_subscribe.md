...
### Описание **socialnetwork.subscribe**

Компонент служит для настройки подписки социальной сети. Компонент является стандартным и входит в дистрибутив модуля.
...
| Шаблон пути к странице подписок | **PATH\_TO\_SUBSCRIBE** | Задается путь к странице подписок социальной сети. |
...
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции на странице в качестве заголовка будет установлено **<пользователь> : Подписка** или **<имя\_группы> : Подписка**. |
| **Имена переменных** | | |
