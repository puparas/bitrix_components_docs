...
### Описание **socialnetwork.blog.post.mail**

Компонент добавляет в почтовый шаблон уведомление о новом посте в блоге или сообщении в Живой ленте.

Компонент относится к модулю [Социальная сеть](/user_help/service/socialnetwork/index.php).

В визуальном редакторе компонент расположен по пути *Общение > Социальная сеть > Уведомление о сообщении*.
