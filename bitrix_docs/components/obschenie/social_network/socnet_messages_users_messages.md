...
### Описание **socialnetwork.messages\_users\_messages**
...
| **Внешний вид** | | |
| Число записей на странице | **ITEMS\_COUNT** | Указывается количество сообщений, отоброжаемых на одной странице. Все сообщения будут выведены с помощью постраничной навигации. |
| **Шаблоны ссылок** | | |
...
| Устанавливать цепочку навигации | **SET\_NAVCHAIN** | [Y|N] При отмеченной опции в цепочку навигации будет добавлен пункт **Переписка**. |
