...
### Описание **socialnetwork.messages\_menu**

Компонент показывает меню сообщений пользователя социальной сети. Компонент является стандартным и входит в дистрибутив модуля.

**Примечание:** Устарел с версии 11.5 в связи с выходом модуля [Веб-мессенджер](/user_help/service/im/index.php) (IM).
...
| **Источник данных** | | |
| Идентификатор страницы | **PAGE\_ID** | Параметр содержит код, в котором передается идентификатор страницы социальной сети. |
| **Шаблоны ссылок** | | |
| Шаблон пути к странице пользователя | **PATH\_TO\_USER** | Задается путь к странице профиля пользователя социальной сети. |
| Шаблон пути к странице переписки | **PATH\_TO\_MESSAGES\_USERS** | Задается путь к странице переписки. |
| Шаблон пути к странице входящих сообщений | **PATH\_TO\_MESSAGES\_INPUT** | Задается путь к странице входящих сообщений социальной сети. |
| Шаблон пути к странице исходящих сообщений | **PATH\_TO\_MESSAGES\_OUTPUT** | Задается путь к странице исходящих сообщений социальной сети. |
| Шаблон пути к странице черного списка | **PATH\_TO\_USER\_BAN** | Задается путь к странице черного списка социальной сети. |
| Шаблон пути к странице обновлений | **PATH\_TO\_LOG** | Задается путь к странице обновлений социальной сети. |
| Шаблон пути к странице подписки | **PATH\_TO\_SUBSCRIBE** | Задается путь к странице подписки социальной сети. |
