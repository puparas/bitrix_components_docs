...
### Описание **socialnetwork.message\_form**

Компонент позволяет отправить сообщение пользователю социальной сети. Компонент является стандартным и входит в дистрибутив модуля.
...
| Код сообщения | **MESSAGE\_ID** | Параметр содержит код, в котором передается идентификатор сообщения социальной сети. |
| **Шаблоны ссылок** | | |
