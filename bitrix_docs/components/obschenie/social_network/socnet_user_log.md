...
### Описание **socialnetwork.activity**

Компонент выводит лог активности пользователя социальной сети. Компонент содержит три шаблона: (**.default**), (**main**) и (**short**). Компонент является стандартным и входит в дистрибутив модуля.

**Примечание:** Устарел, рекомендуется [socialnetwork.log.ex](/user_help/components/obschenie/social_network/socialnetwork.log.ex.php).
