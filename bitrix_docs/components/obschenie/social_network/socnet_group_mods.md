...
### Описание **socialnetwork.group\_mods**

Компонент служит для просмотра и изменения модераторов группы социальной сети. Компонент является стандартным и входит в дистрибутив модуля.
...
| **Внешний вид** | | |
| Количество записей в списке | **ITEMS\_COUNT** | Указывается количество визитных карточек модераторов, отоброжаемых на одной странице. Все визитки будут выведены с помощью постраничной навигации. |
| **Шаблоны ссылок** | | |
...
| Устанавливать цепочку навигации | **SET\_NAVCHAIN** | [Y|N] При отмеченной опции в цепочку навигации будет добавлен пункт **Модераторы группы**. |
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции на странице в качестве заголовка будет установлено **<имя\_группы> : Модераторы группы**. |
| **Имена переменных** | | |
