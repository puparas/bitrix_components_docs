# Приглашения на вступление в группу
...
### Описание **socialnetwork.group\_requests\_out**

Компонент позволяет просмотреть и изменить приглашения на вступление в группу социальной сети. Компонент является стандартным и входит в дистрибутив модуля.

**Примечание:** Устарел, рекомендуется [socialnetwork.group\_requests.ex](/user_help/components/obschenie/social_network/socialnetwork_group_requests_ex.php).
...
| **Внешний вид** | | |
| Количество записей в списках | **ITEMS\_COUNT** | Указывается количество приглашений в группу, отображаемых на одной странице. Все приглашения будут выведены с помощью постраничной навигации. |
| **Шаблоны ссылок** | | |
...
| Шаблон пути к странице приглашения пользователю на вступление в группу | **PATH\_TO\_GROUP\_REQUEST\_SEARCH** | Задается путь к странице запроса к пользователю на вступление в группу социальной сети. |
| **Дополнительные настройки** | | |
| Устанавливать цепочку навигации | **SET\_NAVCHAIN** | [Y|N] При отмеченной опции в цепочку навигации будет добавлен пункт **Приглашения на вступление в группу**. |
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции на странице в качестве заголовка будет установлено **<имя\_группы> : Приглашения на вступление в группу**. |
| **Имена переменных** | | |
