# Сообщение Живой ленты (мобильной)
...
### Описание **mobile.socialnetwork.log.entry**

Отображает сообщение Живой ленты в формате для мобильных устройств. Компонент является стандартным и входит в дистрибутив модуля.
...
```
<?$APPLICATION->IncludeComponent("bitrix:mobile.socialnetwork.log.entry","",Array(
	),
false        
);?>
