# Обработка задания Бизнес-процесса
...
### Описание **socialnetwork.bizproc\_edit**

Компонент позволяет обработать задание бизнес-процесса. Компонент является стандартным и входит в дистрибутив модуля.
...
| Имя переменной для задания | **TASK\_VAR** | Указывается имя переменной, которой передается идентификатор задания некоторого бизнес-процесса. |
| **Шаблоны ссылок** | | |
| Шаблон пути к Бизнес-процессам | **PATH\_TO\_BIZPROC** | Задается путь к странице бизнес-процессов. |
| **Источник данных** | | |
| Идентификатор задания | **TASK\_ID** | Параметр содержит код, в котором передается идентификатор задания некоторого бизнес-процесса. |
| **Дополнительные настройки** | | |
| Устанавливать цепочку навигации | **SET\_NAVCHAIN** | [Y|N] При отмеченной опции в цепочке навигации будет отображаться пункт **Бизнес-процессы**. |
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции на странице в качестве заголовка будет установлено **Обработка задания <номер\_задания>**. |
