...
### Описание **socialnetwork.blog.post.comment.mail**

Компонент добавляет в почтовый шаблон уведомление о комментарии к посту в блоге или сообщению в Живой ленте.

Компонент относится к модулю [Социальная сеть](/user_help/service/socialnetwork/index.php).

В визуальном редакторе компонент расположен по пути *Общение > Социальная сеть > Уведомление о комментарии*.
