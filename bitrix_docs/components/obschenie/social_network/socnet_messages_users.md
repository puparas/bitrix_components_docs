...
### Описание **socialnetwork.messages\_users**

Компонент позволяет показать переписку с пользователями социальной сети. Компонент является стандартным и входит в дистрибутив модуля.
...
| **Внешний вид** | | |
| Число записей на странице | **ITEMS\_COUNT** | Указывается количество записей о переписках с пользователями, отоброжаемых на одной странице. Все записи будут выведены с помощью постраничной навигации. |
| **Шаблоны ссылок** | | |
...
| Устанавливать цепочку навигации | **SET\_NAVCHAIN** | [Y|N] При отмеченной опции в цепочку навигации будет добавлен пункт **Переписка с пользователями**. |
