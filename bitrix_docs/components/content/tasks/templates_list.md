...
### Описание **tasks.templates.list**

Компонент отображения шаблонов задач сотрудника.

В визуальном редакторе компонент расположен по пути: *Контент > Задачи 2.0 > Шаблоны*.
