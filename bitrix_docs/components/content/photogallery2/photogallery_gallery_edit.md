...
### Описание **photogallery.gallery.edit**

Компонент выводит форму редактирования параметров фотогалереи пользователя. Компонент стандартный и входит в дистрибутив модуля.
...
| Код галереи | **USER\_ALIAS** | Указывается символьный код галереи. |
| **Шаблоны ссылок** | | |
...
| Список галерей пользователя | **GALLERIES\_URL** | Указывается адрес страницы со списком галерей пользователя. |
