...
| Указывается число версий, выводимых на одной странице. Если число версий превышает указанное число, начнется постраничная навигация |
| **Шаблоны ссылок** |
...
| Указывается путь к странице редактирования статьи. |
