...
| Количество версий на странице | **HISTORY\_COUNT** | Задается число версий, которые будут выводиться на одной странице. Если число версий превышает указанное число, начнется постраничная навигация. |
| **Шаблоны ссылок** | | |
| Шаблон пути к Wiki-странице | **PATH\_TO\_POST** | Указывается путь к главной странице Wiki. |
| Шаблон пути к странице редактирования Wiki-страницы | **PATH\_TO\_POST\_EDIT** | Указывается путь к странице редактирования Wiki-страницы. |
