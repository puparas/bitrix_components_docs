...
### Описание **lists.fields**

Компонент показывает поля универсального списка и позволяет их редактировать. Компонент является стандартным и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути: *Контент > Универсальные списки > Поля списка*.
