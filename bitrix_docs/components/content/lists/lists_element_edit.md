...
### Описание **lists.element.edit**

Компонент выводит форму редактирования элемента списка.

В визуальном редакторе компонент расположен по пути: *Контент > Универсальные списки > Редактирование элемента*.
...
| Элемент | **ELEMENT\_ID** | Указывается код, в котором передается идентификатор элемента. По умолчанию указано **={$\_REQUEST["element\_id"]}**. |
| **Шаблоны ссылок** | | |
| URL главной страницы списков | **LISTS\_URL** | Указывается шаблон ссылки на главную страницу универсальных списков. |
| URL раздела списка | **LIST\_URL** | Указывается шаблон ссылки на страницу раздела списка. |
| URL элемента списка | **LIST\_ELEMENT\_URL** | Указывается шаблон ссылки на страницу элемента списка. |
| URL просмотра журнала бизнес-процесса | **BIZPROC\_LOG\_URL** | Указывается шаблон ссылки на страницу журнала бизнес-процессов. |
| BIZPROC\_WORKFLOW\_START\_URL | **LIST\_URL** | Указывается шаблон ссылки на страницу запуска бизнес-процесса. |
| URL задачи бизнес-процесса | **BIZPROC\_TASK\_URL** | Указывается шаблон ссылки на страницу задачи бизнес-процесса. |
