...
Компонент позволяет показывать внешние сущности на календарной сетке. Требует использования [**API**](https://dev.1c-bitrix.ru/api_d7/bitrix/calendar/index.php) модуля **calendar**. Компонент является стандартным и входит в дистрибутив модуля.
