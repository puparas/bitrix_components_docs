...
| **Основные параметры** | | |
| Тип календаря | **CALENDAR\_TYPE** | Указывается тип календаря событий:  * Календарь компании; * События; * Календари групп; * Календари пользователей; * Бронирование преговорных; * Бронирование видео-переговорных. |
| Секция календаря | **CALENDAR\_SECTION\_ID** | Выбирается секция, события которой следует отобразить. Опция видна при выборе **Календарь компании** в опции **Тип календаря**. |
| Показывать события текущего пользователя | **B\_CUR\_USER\_LIST** | [Y|N] При отмеченной опции будут показаны события календаря текущего пользователя. |
