...
### Описание **crm.lead.edit**

Одностраничный компонент, позволяет добавлять новый, или редактировать параметры имеющегося лида. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Лиды > Редактирование лида*.
