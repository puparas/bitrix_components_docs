...
### Описание **crm.lead.convert**

Одностраничный компонент, позволяет конвертировать лид в контакт, компанию и сделку. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Лиды > Конвертация лида*.
