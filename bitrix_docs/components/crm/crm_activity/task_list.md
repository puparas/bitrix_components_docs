...
### Описание **crm.activity.task.list**

Одностраничный компонент выводит список задач. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Дела > Список задач*.
...
| **Основные параметры** | | |
| Количество задач на странице | **ACTIVITY\_TASK\_COUNT** | Число выводимых на одну страницу задач. |
