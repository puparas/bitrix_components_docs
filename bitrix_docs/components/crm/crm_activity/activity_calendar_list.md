...
[Дела](/user_help/components/crm/crm_activity/crm_activity.php)
...
### Описание **crm.activity.calendar.list**

Одностраничный компонент выводит список записей календаря. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Дела > Список звонков/встреч*.
...
| **Основные параметры** | | |
| Количество звонков на странице | **ACTIVITY\_TASK\_COUNT** | Число выводимых на одну страницу записей календаря. |
