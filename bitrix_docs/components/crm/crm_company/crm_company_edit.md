...
### Описание **crm.company.edit**

Одностраничный компонент, позволяет добавлять новую, или редактировать параметры имеющейся компании. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Компании > Редактирование компании*.
