...
### Описание **crm.company.list**

Одностраничный компонент выводит список компаний. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Компании > Список компаний*.
...
| **Основные параметры** | | |
| Количество компаний на странице | **COMPANY\_COUNT** | Число выводимых на одну страницу компаний. |
