...
### Описание **crm.deal.list**

Одностраничный компонент выводит список сделок. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Сделки > Список сделок*.
...
| **Основные параметры** | | |
| Количество сделок на странице | **DEAL\_COUNT** | Число выводимых на одну страницу сделок. |
