...
### Описание **crm.deal.edit**

Одностраничный компонент, позволяет добавлять новую, или редактировать параметры существующей сделки. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Сделки > Редактирование сделки*.
