...
### Описание **crm.deal.funnel**

Одностраничный компонент, выводит количественное соотношение сделок на разных стадиях выполнения. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Сделки > Воронка продаж*.
...
| **Основные параметры** | | |
| Отключить компенсацию стадий | **DISABLE\_COMPENSATION** | При отмеченной опции каждая нижележащая стадия воронки продаж не будет включать в себя предыдущие. |
