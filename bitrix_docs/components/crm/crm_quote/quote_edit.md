...
### Описание **crm.quote.edit**

Одностраничный компонент, позволяет добавлять новое, или редактировать параметры существующего предложения. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Предложения > Редактирование предложения*.
