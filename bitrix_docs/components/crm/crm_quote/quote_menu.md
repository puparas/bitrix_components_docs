...
### Описание **crm.quote.menu**

Одностраничный компонент, позволяет настроить контентное меню сущности.

В визуальном редакторе компонент расположен по пути *CRM > Предложения > Панель инструментов*.
...
| Вид отображения меню | **TYPE** | Выбирается функционал для представления в контентном меню. Возможны три варианта:  * LIST; * SHOW; * EDIT. |
