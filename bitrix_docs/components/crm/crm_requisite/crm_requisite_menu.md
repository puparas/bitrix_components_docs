...
### Описание **crm.requisite.menu**

Компонент выводит панель инструментов.

В визуальном редакторе компонент находится в *Компоненты > CRM > Реквизиты > Панель инструментов*.
...
| **Основные параметры** | | |
| ID реквизитов | **ELEMENT\_ID** | Поле содержит код, в котором передается идентификатор реквизитов. |
