...
### Описание **crm.requisite.list**

Компонент выводит список реквизитов компании.

В визуальном редакторе компонент находится в *Компоненты > CRM > Реквизиты > Список реквизитов*.
...
| **Основные параметры** | | |
| Количество реквизитов на странице | **REQUISITE\_COUNT** | Указывается число реквизитов, отображаемых на одной странице. |
