...
В визуальном редакторе компонент расположен по пути *CRM > Контакты > Панель инструментов*.
...
| Вид отображения меню | **TYPE** | Выбирается функционал для представления в контентном меню. Возможны четыре варианта:  * **LIST** - выводятся кнопки **Добавить контакт**, **Импорт контактов**, **Экспорт контактов**; * **SHOW** - выводятся кнопки **Список контактов**, **Добавить контакт**; * **EDIT** - выводятся кнопки **Список контактов**, **Добавить контакт**; * **IMPORT** - выводятся кнопки **Список контактов**, **Добавить контакт**. |
