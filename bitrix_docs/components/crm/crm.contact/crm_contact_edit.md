...
### Описание **crm.contact.edit**

Одностраничный компонент, позволяет добавлять новый, или редактировать параметры имеющегося контакта. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Контакты > Редактирование контакта*.
