...
### Описание **crm.invoice.edit**

Одностраничный компонент, позволяет добавлять новый, или редактировать параметры имеющегося счёта. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Счета > Редактирование счёта*.
