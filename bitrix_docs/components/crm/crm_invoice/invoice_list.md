...
### Описание **crm.invoice.list**

Одностраничный компонент выводит список счетов. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Счета > Список счетов*.
...
| **Основные параметры** | | |
| Количество счетов на странице | **DEAL\_COUNT** | Число выводимых на одну страницу счетов. |
