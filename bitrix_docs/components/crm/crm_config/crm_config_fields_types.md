...
### Описание **crm.config.fields.types**

Одностраничный компонент, выводит список типов пользовательских полей модуля CRM. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Настройки > Список типов пользовательских полей*.
