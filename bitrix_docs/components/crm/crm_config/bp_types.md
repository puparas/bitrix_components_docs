# Список типов шаблонов бизнес-процессов
...
### Описание **crm.config.bp.types**

Одностраничный компонент, выводит список типов шаблонов бизнес-процессов. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Настройки > Список типов шаблонов бизнес-процессов*.
...
| URL редактирования шаблона | **BP\_EDIT\_URL** | Указывается страница редактирования шаблона. |
