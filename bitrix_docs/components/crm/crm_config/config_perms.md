...
### Описание **crm.config.perms.relation**

Одностраничный компонент, позволяет настроить связь ролей с группами сотрудников. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Настройки > Настройка связей ролей*.
