...
### Описание **crm.config.fields.list**

Одностраничный компонент, выводит список пользовательских полей модуля CRM. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Настройки > Список пользовательских полей*.
...
| Тип полей | **FIELS\_ENTITY\_ID** | Указывается тип дополнительных полей. Возможен выбор из трех вариантов:  * **Лид/контакт**; * **Компания**; * **Сделка**. |
| **Шаблоны ссылок** | | |
