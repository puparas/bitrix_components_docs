...
### Описание **crm.config.perms.role.edit**

Одностраничный компонент, позволяет выполнить настройку прав доступа роли к сущностям CRM. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Настройки > Редактирование роли*.
...
| **Шаблоны ссылок** | | |
| URL привязки ролей | **PATH\_TO\_ENTITY\_LIST** | Указывается страница со списком ролей. |
| URL редактирования роли | **PATH\_TO\_ROLE\_EDIT** | Указывается страница редактирования роли. |
| **Дополнительные настройки** | | |
| Идентификатор роли | **ROLE\_ID** | Указывается идентификатор роли. |
