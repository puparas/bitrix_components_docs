# Список шаблонов реквизитов клиентов
...
### Описание **crm.config.preset.list**

Одностраничный компонент, выводит выводит список шаблонов реквизитов клиентов модуля CRM. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Настройки > Список шаблонов реквизитов клиентов*.
