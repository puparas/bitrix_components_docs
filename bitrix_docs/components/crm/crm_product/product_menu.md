...
### Описание **crm.product.menu**

Одностраничный компонент, позволяет настроить контентное меню для работы с каталогами и товарами. Компонент стандартный и входит в дистрибутив модуля.

В визуальном редакторе компонент расположен по пути *CRM > Товары > Туллбар*.
...
| **Основные параметры** | | |
| Тип | **TYPE** | Выбирается вид контентного меню. Виды характеризуются функционалом набора кнопок. |
| Идентификатор раздела | **SECTION\_ID** | Указывается идентификатор раздела. |
| Идентификатор товара | **PRODUCT\_ID** | Указывается идентификатор товара. |
| Шаблон пути к странице списка товаров | **PATH\_TO\_PRODUCT\_LIST** | Указывается путь к странице с перечнем товаров выбранного раздела. |
...
| Шаблон пути к странице списка разделов | **PATH\_TO\_SECTION\_LIST** | Указывается путь к странице списка разделов. |
