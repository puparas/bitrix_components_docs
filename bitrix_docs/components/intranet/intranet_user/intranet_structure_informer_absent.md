...
### Описание **intranet.structure.informer.absent**

Компонент выводит краткий список отсутствующих сотрудников. Компонент является стандартным и входит в дистрибутив модуля.
...
| **Основные параметры** | | |
| Количество выводимых записей | **NUM\_USERS** | Указывается количество выводимых записей. |
...
| Отдел/офис | **DEPARTMENT** | Указывается офис, филиал или отдел, краткий список отсутствующих сотрудников которого будет отображен. |
