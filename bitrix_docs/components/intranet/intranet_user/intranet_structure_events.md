...
### Описание **intranet.structure.events**

Компонент выводит список последних кадровых перестановок в компании. Компонент является стандартным и входит в дистрибутив модуля.
...
| Имя фильтра страницы структуры компании | **STRUCTURE\_FILTER** | Задается имя фильтра страницы структуры компании. |
| Количество выводимых на странице записей | **NUM\_USERS** | Параметр определяет количество отображаемых на одной странице записей. Все записи будут выведены с помощью постраничной навигации. |
...
| Страница видеозвонка | **PATH\_TO\_VIDEO\_CALL** | Указывается путь к странице видеозвонка. |
| Отображать фильтр | **SHOW\_FILTER** | [Y|N] При отмеченной опции будет отображаться панель выбора подразделения. Если опция не отмечена, то будет показан весь список кадровых изменений. |
| Подпись постраничной навигации | **NAV\_TITLE** | Указывается подпись для постраничной навигации. |
| Выводить постраничную навигацию над списком | **SHOW\_NAV\_TOP** | [Y|N] При отмеченной опции постраничная навигация будет показываться над списком. |
| Выводить постраничную навигацию под списком | **SHOW\_NAV\_BOTTOM** | [Y|N] При отмеченной опции постраничная навигация будет показываться под списком. |
| Пользовательские поля для вывода | **USER\_PROPERTY** | Указываются поля пользователей, которые будут показаны в визитных карточках при просмотре в виде списка. |
