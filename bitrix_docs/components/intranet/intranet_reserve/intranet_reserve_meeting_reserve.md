...
### Описание **intranet.reserve\_meeting.reserve**
...
| Код переговорной | **MEETING\_ID** | Код, используемый для идентификации переговорной. |
| Код резервирования | **ITEM\_VAR** | Код, используемый для резервирования переговорной. |
...
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции в качестве заголовка страницы будет установлено **Резервирование переговорной: <название\_переговорной>**. |
...
| Имя переменной для идентификатора резервирования | **ITEM\_ID** | Указывается имя переменной, используемой для идентификатора резервирования. |
