...
### Описание **intranet.reserve\_meeting.menu**

Компонент выводит меню комплексного компонента. Компонент является стандартным и входит в дистрибутив модуля.
...
| Код страницы | **PAGE\_ID** | Код, используемый для идентификации страницы. |
...
| Путь к главной странице резервирования переговорных | **PATH\_TO\_MEETING\_LIST** | Указывается путь к странице со списком переговорных от корня сайта. |
| Путь к странице изменения переговорной | **PATH\_TO\_MODIFY\_MEETING** | Указывается путь к странице изменения переговорной от корня сайта. |
...
| Путь к странице поиска переговорной | **PATH\_TO\_SEARCH** | Указывается путь к странице поиска переговорной от корня сайта. |
...
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции в качестве заголовка страницы будет установлено название переговорной. |
