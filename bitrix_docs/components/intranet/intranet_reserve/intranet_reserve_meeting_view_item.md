...
### Описание **intranet.reserve\_meeting.view\_item**

Комплексный компонент, позволяет управлять списком дел.

В визуальном редакторе компонент расположен по пути *CRM > Дела > Дела*.
...
| Код резервирования | **ITEM\_ID** | Код, используемый для резервирования переговорной. |
| **Шаблоны ссылок** | | |
...
| Устанавливать заголовок страницы | **SET\_TITLE** | [Y|N] При отмеченной опции в качестве заголовка страницы будет установлено **Просмотр резервирования переговорной: <название\_события>**. |
...
| Имя переменной для идентификатора бронирования | **ITEM\_VAR** | Указывается имя переменной, используемой для идентификатора бронирования. |
