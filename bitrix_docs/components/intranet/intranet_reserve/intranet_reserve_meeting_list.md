...
### Описание **intranet.reserve\_meeting.list**

Компонент выводит список переговорных. Компонент является стандартным и входит в дистрибутив модуля.
...
| Группы пользователей, которые могут резервировать переговорные | **USERGROUPS\_RESERVE** | Указываются группы пользователей, которые будут осуществлять резервирование переговорных комнат. |
| **Шаблоны ссылок** | | |
