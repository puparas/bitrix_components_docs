# Форма инициализации регистрации
...
### Описание **system.auth.initialize**

Компонент выводит форму инициализации регистрации, созданной в рамках соцсети. Компонент стандартный и входит в дистрибутив модуля.
...
| Название переменной, в которой передается ID пользователя | **USER\_ID** | Указывается название переменной для передачи ID пользователя. По умолчанию - user\_id. |
| Название переменной, в которой передается контрольная строка | **CHECKWORD** | Указывается название переменной для передачи контрольной строки. По умолчанию - checkword. |
